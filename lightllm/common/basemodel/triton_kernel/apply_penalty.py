...
def _fwd_kernel_apply_penalty(
    ...
    p_token_ids, p_token_counts, p_cumsum_seq_len, exponential_decay_length_penalties, length_penalty_idx,
    eos_ids, mask_eos_reqs, stride_logit_b, stride_logit_s,
...
@torch.no_grad()
def apply_penalty(Logits, presence_penalty, freqency_penalty, repetition_penalty,
                  p_token_ids, p_token_counts, p_cumsum_seq_len, exponential_decay_length_penalties, length_penalty_idx,
                  eos_ids, mask_eos_reqs):

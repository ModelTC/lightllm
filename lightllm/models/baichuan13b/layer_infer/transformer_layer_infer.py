...
from lightllm.models.baichuan13b.layer_weights.transformer_layer_weight import (
    BaiChuan13bTransformerLayerWeight,
)
...
class Baichuan13bTransformerLayerInfer(LlamaTransformerLayerInfer):
    ...
    def _bind_func(self):
        ...
        self._context_attention_kernel = partial(
            BloomTransformerLayerInfer._context_attention_kernel, self
        )
        self._token_attention_kernel = partial(
            BloomTransformerLayerInfer._token_attention_kernel, self
        )
        return
    ...
    def _get_qkv(
        ...
        cache_v,
        infer_state,
        layer_weight: BaiChuan13bTransformerLayerWeight,
    ) -> torch.Tensor:

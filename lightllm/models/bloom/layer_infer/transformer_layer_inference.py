...
from lightllm.models.bloom.layer_weights.transformer_layer_weight import TransformerLayerWeight
...
class TransformerLayerInfer:
    ...
    def __init__(self, layer_num, tp_rank, world_size, network_config):

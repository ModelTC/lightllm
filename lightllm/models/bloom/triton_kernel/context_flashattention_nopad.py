...
if triton.__version__ >= "2.1.0":
    ...
    def _fwd_kernel(
        ...
        for start_n in range(0, block_mask * block_end_loc * BLOCK_M, BLOCK_N):
            ...
            qk = tl.where((offs_m[:, None] + ready_cache_len) >= (start_n + offs_n[None, :]), qk, -10000000.)
    ...
    @torch.no_grad()
    def context_attention_fwd(q, k, v, o, b_req_idx, alibi, b_start_loc, b_seq_len, b_ready_cache_len, max_input_len, req_to_token_indexs):
        BLOCK = 128
        # shape constraints

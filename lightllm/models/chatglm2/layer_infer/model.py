...
import json
import torch
from lightllm.models.chatglm2.layer_infer.pre_layer_inference import PreLayerInfer
from lightllm.models.chatglm2.layer_infer.post_layer_inference import PostLayerInfer
from lightllm.models.chatglm2.layer_infer.transformer_layer_inference import TransformerLayerInfer
...
from lightllm.models.chatglm2.layer_weights.hf_load_utils import load_hf_weights
from lightllm.common.mem_manager import MemoryManager
from lightllm.common.infer_utils import init_bloc

class ChatGlm2TpPartModel:
    def __init__(self, tp_rank, world_size, weight_dir, max_total_token_num, load_way="HF", mode=""):
        ...
        assert self.config["multi_query_group_num"] % world_size == 0
        self.mem_manager = MemoryManager(max_total_token_num,  
                                         dtype=torch.float16,
                                         head_num=self.config["multi_query_group_num"] // world_size,
                                         head_dim=self.config["hidden_size"] // self.config["num_attention_heads"],
                                         layer_num=self.config["num_layers"])
        ...
        self.tp_kv_head_num_ = self.config["multi_query_group_num"]  #// self.world_size_
    ...
    def init_to_get_rotary(self, base=10000):
        ...
        base = float(base)
        inv_freq = 1.0 / (base ** (torch.arange(0, 64, 2, device="cpu", dtype=torch.float32) / 64))

...
from lightllm.models.chatglm2.layer_weights.pre_and_post_layer_weight import PreAndPostLayerWeight
...
class PostLayerInfer:
    ...
    def __init__(self, tp_rank, world_size, network_config):
        ...
        assert (network_config["padded_vocab_size"] % self.world_size_ == 0)
        self.vocab_size_ = network_config["padded_vocab_size"]
        self.tp_vocab_size_ = network_config["padded_vocab_size"] // self.world_size_

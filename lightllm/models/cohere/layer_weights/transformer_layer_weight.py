...
class CohereTransformerLayerWeight(TransformerLayerWeight):
    ...
    def _load_qkvo_weights(self, weights):
        ...
        kv_split_n_head = self.network_config_["num_key_value_heads"] // self.world_size_
        q_split_n_head = self.network_config_["num_attention_heads"] // self.world_size_

        # q k v weights and q k norm for cohere

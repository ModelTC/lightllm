...
class InternlmTransformerLayerInferWquant(TransformerLayerInferWeightQuantTpl):
    ...
    def _bind_matmul(self):
        if "triton_int8weight" in self.mode:
            func = partial(InternlmTransformerLayerInferWquant._wquant_matmul_triton_int8weight_only_quant, self)
            ...
            func = partial(InternlmTransformerLayerInferWquant._wquant_matmul_triton_int4weight_only_quant, self)
            self._wquant_matmul_for_qkv = func
            self._wquant_matmul_for_o = func
            self._wquant_matmul_for_ffn_up = func
            self._wquant_matmul_for_ffn_down = func
            ...
            func = partial(InternlmTransformerLayerInferWquant._wquant_matmul_lmdeploy_int4weight_only_quant, self)
            self._wquant_matmul_for_qkv = func
            self._wquant_matmul_for_o = func
            self._wquant_matmul_for_ffn_up = func
            self._wquant_matmul_for_ffn_down = func
            ...
            func = partial(InternlmTransformerLayerInferWquant._wquant_matmul_ppl_int4weight_only_quant, self)
            self._wquant_matmul_for_qkv = func
            self._wquant_matmul_for_o = func
            self._wquant_matmul_for_ffn_up = func
            self._wquant_matmul_for_ffn_down = func
    ...
    def _ffn(self, input, infer_state: LlamaInferStateInfo, layer_weight: InternlmTransformerLayerWeightQuantized) -> torch.Tensor:

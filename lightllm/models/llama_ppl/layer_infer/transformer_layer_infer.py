...
class LlamaPPlTransformerLayerInfer(LlamaTransformerLayerInfer):
    ...
    def _token_attention_kernel(
        ...
        # group_int8kv_decode_attention(at::Tensor o, at::Tensor q, at::Tensor
        # k, at::Tensor k_s,  at::Tensor v,  at::Tensor v_s, at::Tensor b_loc,
        # at::Tensor b_seq_len, int max_len_in_batch)

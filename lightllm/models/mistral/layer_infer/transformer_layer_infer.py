...
from lightllm.models.mistral.triton_kernel.context_flashattention_nopad import (
    context_attention_fwd,
)
from lightllm.models.mistral.triton_kernel.token_attention_nopad_att1 import (
    token_att_fwd,
)
from lightllm.models.mistral.triton_kernel.token_attention_nopad_reduceV import (
    token_att_fwd2,
)
...
class MistralTransformerLayerInfer(LlamaTransformerLayerInfer):
    ...
    def _context_attention_kernel(
        self, q, k, v, infer_state: MistralInferStateInfo, layer_weight, out=None
    ) -> torch.Tensor:
    ...
    def _token_decode_attention_normal(
        self, q, infer_state: MistralInferStateInfo, layer_weight, out=None
    ):

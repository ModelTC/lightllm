...
class StarcoderPreLayerInfer(PreLayerInfer):
    ...
    def context_forward(self, input_ids, infer_state: StarcoderInferStateInfo,
        ...
        if self.world_size_ > 1:
            dist.all_reduce(
                ...
                async_op=False)
        position_embeds = torch.embedding(
    ...
    def token_forward(self, input_ids, infer_state: StarcoderInferStateInfo,
                      layer_weight: PreAndPostLayerWeight):

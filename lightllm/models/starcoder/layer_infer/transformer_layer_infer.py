...
class StarcoderTransformerLayerInfer(BloomTransformerLayerInfer):
    ...
    def _context_attention_kernel(self, q, k, v, infer_state: StarcoderInferStateInfo,
                                  layer_weight: StarcoderTransformerLayerWeight) -> torch.Tensor:
    ...
    def _token_attention_kernel(self, q, infer_state: StarcoderInferStateInfo,
                                layer_weight: StarcoderTransformerLayerWeight) -> torch.Tensor:

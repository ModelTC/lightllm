...
from lightllm.models.starcoder_wquant.layer_infer.transformer_layer_infer import (
    StarcoderTransformerLayerInferWQuant,
)
...
class StarcoderTpPartModelWQuant(StarcoderTpPartModel):
    ...
    def _verify_params(self):
        ...
        assert any(
            "int8weight" in mode_ or "int4weight" in mode_ for mode_ in self.mode

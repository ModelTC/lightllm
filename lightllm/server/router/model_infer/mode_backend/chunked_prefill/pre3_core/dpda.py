...
class DPDA:
        ...
        for graph_node in self.lr_graph.origin_graph.graph_nodes:
            ...
            if len(tmp_edges) == 0:
                ...
                for edge in tmp_edges:
                    assert edge.transfer_input == tmp_edges[0].transfer_input
    ...
    def try_shift(self, input_str: str, current_stack, current_node_id):
        # given a input string, simulate the dpda transition
        # print: transition process
        # return: (is_ok: bool, final_stack: List[int], final_node_id: int)
        stack = copy.deepcopy(current_stack)
        ...
        return True, stack, current_node_id
...
if __name__ == "__main__":
    ...
    for in_str in ["a", "aa", "aaa", "aaab", "aaaaabbbb", "aaaabbbbb"]:
        try:
            dpda.accept(in_str)

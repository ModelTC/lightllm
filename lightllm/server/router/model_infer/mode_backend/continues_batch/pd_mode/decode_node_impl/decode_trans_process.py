        ...
        while True:
            ...
            try:
                ...
                if total_move_kv_len != 0:
                    ...
                    if kv_trans_use_p2p():
                        cur_mem.receive_from_prefill_node_p2p(move_tasks, mem_managers, dp_size_in_node)
                    else:
                        cur_mem.receive_from_prefill_node(move_tasks, mem_managers, dp_size_in_node)

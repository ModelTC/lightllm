...
def prepare_mtp_prefill_inputs(
    model_input: ModelInput, b_next_token_ids: torch.Tensor, dedeepseekv3_mtp_draft_input_hiddens: torch.Tensor
):
    ...
    new_model_input.deepseekv3_mtp_draft_input_hiddens = dedeepseekv3_mtp_draft_input_hiddens

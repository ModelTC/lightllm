...
def func(rank_id, world_size, ans_queue):
    ...
    model_part = LlamaTpPartModel(dist.get_rank(), dist.get_world_size(), max_total_token_num= 2048 * 50, weight_dir=test_model_dir, load_way="HF")
    ...
    logics = model_part.forward(test_batch_size, total_token_num, max_len_in_batch, input_ids,
    ...
    for i in range(12):
        ...
        logics = model_part.forward(test_batch_size, total_token_num, max_len_in_batch, torch.from_numpy(

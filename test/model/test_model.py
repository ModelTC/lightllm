...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_len", type=int, default=1000, help="input sequence length")
    parser.add_argument("--output_len", type=int, default=2000, help="output sequence length")
    parser.add_argument(
        "--profile",
        action="store_true",
